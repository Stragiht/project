 ...
 * 入职流程列表
 */
app.controller('entryApplCtrl', function($scope, $sessionStorage, $ionicPopup,
  ...
  $scope.doRefresh = function() {
    ...
    comApi.post('entryAppl/selectEntryApplListM', {
  ...
  $scope.loadMore = function() {
    comApi.post('entryAppl/selectEntryApplListM', {
      ...
      Array.prototype.push.apply($scope.entryApplList, data.list); // 拼接结果集
      $scope.moredata = data.hasNextPage;
      $scope.pageNum = data.pageNum;

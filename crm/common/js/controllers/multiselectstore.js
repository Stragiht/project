app.controller("multiSelectStoreController", function($scope, $modal, NgTableParams,
...
//			var storeData = $scope.tableParams.data;
			...
			for(var i =0; i<storeData.length;i++){
				...
				if(typeof($scope.checkboxes.items[storeData[i].strNum]) != "undefined"){
					if($scope.checkboxes.items[storeData[i].strNum]){
